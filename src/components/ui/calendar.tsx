  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          'bg-orange-1 text-slate-50 hover:bg-orange-1 hover:text-slate-50 focus:bg-orange-1 focus:text-slate-50 dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-50 dark:hover:text-slate-900 dark:focus:bg-slate-50 dark:focus:text-slate-900',
